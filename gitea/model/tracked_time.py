...
class TrackedTime(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            issue (Issue): [optional]  # noqa: E501
            issue_id (int): deprecated (only for backwards compatibility). [optional]  # noqa: E501
            time (int): Time in seconds. [optional]  # noqa: E501
            user_id (int): deprecated (only for backwards compatibility). [optional]  # noqa: E501
