...
import time
import gitea
from gitea.api import organization_api
...
with gitea.ApiClient(configuration) as api_client:
    ...
    try:
        # Create a repository in an organization
        api_response = api_instance.create_org_repo(org)
        pprint(api_response)
...
with gitea.ApiClient(configuration) as api_client:
    ...
    try:
        # Create a repository in an organization
        api_response = api_instance.create_org_repo_deprecated(org)
        pprint(api_response)
    except gitea.ApiException as e:
...
with gitea.ApiClient(configuration) as api_client:
    ...
    try:
        # Create a label for an organization
        api_response = api_instance.org_create_label(org)
        pprint(api_response)
    except gitea.ApiException as e:
...
with gitea.ApiClient(configuration) as api_client:
    ...
    ) # CreateTeamOption |  (optional)

    # example passing only required values which don't have defaults set
    try:
        # Create a team
        api_response = api_instance.org_create_team(org)
        pprint(api_response)
    except gitea.ApiException as e:
...
with gitea.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = organization_api.OrganizationApi(api_client)
    id = 1 # int | id of the team to delete
...
with gitea.ApiClient(configuration) as api_client:
    ...
    api_instance = organization_api.OrganizationApi(api_client)
    org = "org_example" # str | name of the organization
    id = 1 # int | id of the hook to update
    body = EditHookOption(
        active=True,
        branch_filter="branch_filter_example",
        config={
...
with gitea.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a label
        api_response = api_instance.org_edit_label(org, id)
        pprint(api_response)
    except gitea.ApiException as e:
...
with gitea.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = organization_api.OrganizationApi(api_client)
    id = 1 # int | id of the team to edit
    body = EditTeamOption(
        can_create_org_repo=True,
        description="description_example",
        includes_all_repositories=True,
        ...
        permission="read",
        units=[repo.code, repo.issues, repo.ext_issues, repo.wiki, repo.pulls, repo.releases, repo.projects, repo.ext_wiki],
    ) # EditTeamOption |  (optional)

    # example passing only required values which don't have defaults set
    try:
        # Edit a team
        api_response = api_instance.org_edit_team(id)
        pprint(api_response)
    except gitea.ApiException as e:
...
with gitea.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = organization_api.OrganizationApi(api_client)
    id = 1 # int | id of the team to get
...
with gitea.ApiClient(configuration) as api_client:
    ...
    try:
        # List an organization's labels
        api_response = api_instance.org_list_labels(org)
        pprint(api_response)
    except gitea.ApiException as e:
...
# **team_search**
> TeamSearch200Response team_search(org)
...
with gitea.ApiClient(configuration) as api_client:
    ...
    try:
        # Search for teams within an organization
        api_response = api_instance.team_search(org)
        pprint(api_response)
    except gitea.ApiException as e:
