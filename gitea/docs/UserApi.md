...
import time
import gitea
from gitea.api import user_api
...
with gitea.ApiClient(configuration) as api_client:
    ...
    access_token = UserCreateTokenRequest(
        name="name_example",
    ) # UserCreateTokenRequest |  (optional)
 ...
 **access_token** | [**UserCreateTokenRequest**](UserCreateTokenRequest.md)|  | [optional]
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**201** | AccessToken represents an API access token. |  * sha1 -  <br>  * name -  <br>  * token_last_eight -  <br>  * id -  <br>  |
...
# **user_search**
> UserSearch200Response user_search()
