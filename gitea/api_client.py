...
from gitea.exceptions import ApiTypeError, ApiValueError, ApiException
from gitea.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.admin_adopt_repository  # this is an instance of the class Endpoint
        api_instance.admin_adopt_repository()  # this invokes api_instance.admin_adopt_repository.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.admin_adopt_repository.callable or self.callable in this class
