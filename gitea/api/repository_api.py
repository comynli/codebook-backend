...
class RepositoryApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.repo_add_topc_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'AccessToken',
        ...
        self.repo_download_pull_diff_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'AccessToken',
                ...
                'endpoint_path': '/repos/{owner}/{repo}/pulls/{index}.diff',
                'operation_id': 'repo_download_pull_diff',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.repo_download_pull_patch_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'AccessToken',
                ...
                'endpoint_path': '/repos/{owner}/{repo}/pulls/{index}.patch',
                'operation_id': 'repo_download_pull_patch',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def repo_add_topc(
        ...
        **kwargs
        ...
        kwargs['topic'] = \
            topic
        return self.repo_add_topc_endpoint.call_with_http_info(**kwargs)
    ...
    def repo_download_pull_diff(
        ...
        **kwargs
        ...
        >>> thread = api.repo_download_pull_diff(owner, repo, index, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['index'] = \
            index
        return self.repo_download_pull_diff_endpoint.call_with_http_info(**kwargs)

    def repo_download_pull_patch(
        self,
        owner,
        repo,
        index,
        **kwargs
        ...
        >>> thread = api.repo_download_pull_patch(owner, repo, index, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['index'] = \
            index
        return self.repo_download_pull_patch_endpoint.call_with_http_info(**kwargs)
